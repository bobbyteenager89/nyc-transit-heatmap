...
export function MapLegend() {
  ...
  return (
    <div className="absolute bottom-36 md:bottom-6 right-4 md:right-6 z-10 bg-surface-card/90 border border-white/10 rounded-lg px-4 py-2.5 backdrop-blur-sm">
